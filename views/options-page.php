...
$subscribr_options->HelpTab(
	array(
		...
		'content' => sprintf(__('<p>Get support on the WordPress.org forums: <a href="http://wordpress.org/support/plugin/%1$s" target="_blank">http://wordpress.org/support/plugin/%1$s</a></p><p>To get premium one-on-one support, contact us: <a href="https://mind.sh/are/contact/" target="_blank">https://mind.sh/are/contact/</a></p>', 'subscribr'), SUBSCRIBR_PLUGIN_SLUG),
	)
);
$secure_tab_content = sprintf(__('<p>Get the Mindshare Team to secure and protect your WordPress site for $9.95/month: <a href="https://mind.sh/are/wordpress-security-and-backup-service/check/?url=%1$s&amp;active=0&amp;sale=1&amp;d=%2$s" target="_blank">https://mind.sh/are/wordpress-security-and-backup-service/</a></p>', 'subscribr'), get_bloginfo("url"), str_replace(array(
																																																																																													  "http://",
																																																																																													  "https://",
																																																																																												  ), "", get_home_url()));
